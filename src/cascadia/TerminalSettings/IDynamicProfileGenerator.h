...
class winrt::Microsoft::Terminal::Settings::Model::IDynamicProfileGenerator
{
public:
    virtual ~IDynamicProfileGenerator() = 0;
    virtual std::wstring_view GetNamespace() = 0;
    virtual std::vector<Profile> GenerateProfiles() = 0;
};
inline winrt::Microsoft::Terminal::Settings::Model::IDynamicProfileGenerator::~IDynamicProfileGenerator() {}
