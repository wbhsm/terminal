...
Abstract:
- Helpers for the TerminalSettings project dedicated to
   serialize Json data
Author(s):
...
namespace winrt::Microsoft::Terminal::Settings::Model::JsonUtils
{
    namespace Detail
    {
...
#define JSON_ENUM_MAPPER(...)                                       \
    template<>                                                      \
    struct winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<__VA_ARGS__> : \
        public winrt::Microsoft::Terminal::Settings::Model::JsonUtils::EnumMapper<__VA_ARGS__, winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<__VA_ARGS__>>

#define JSON_FLAG_MAPPER(...)                                       \
    template<>                                                      \
    struct winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<__VA_ARGS__> : \
        public winrt::Microsoft::Terminal::Settings::Model::JsonUtils::FlagMapper<__VA_ARGS__, winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<__VA_ARGS__>>
